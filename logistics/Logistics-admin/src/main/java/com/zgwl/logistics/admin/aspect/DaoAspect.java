package com.zgwl.logistics.admin.aspect;

import java.util.Date;

import javax.servlet.http.HttpServletRequest;

import com.zgwl.logistics.admin.util.SecurityUtils;
...
import com.zgwl.logistics.common.utils.StringUtils;
...
public class DaoAspect {
    ...
    @Pointcut("execution(* com.zgwl.logistics.*.dao.*.update*(..))")
    public void daoUpdate() {
    }

    @Pointcut("execution(* com.zgwl.logistics.*.dao.*.insert*(..))")
